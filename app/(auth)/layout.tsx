  ...
  return (
    <>
      <main className="relative mx-auto flex w-full max-w-lg flex-col items-stretch px-4 py-10 sm:px-6">
        ...
        <div
          aria-hidden
          className="pointer-events-none absolute inset-x-0 -top-10 -z-10 mx-auto h-56 w-[28rem] max-w-[110vw] rounded-full bg-[radial-gradient(ellipse_at_center,rgba(64,145,108,0.32),transparent_65%)] blur-2xl"
        />
